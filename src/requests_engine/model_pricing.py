...
class ModelPricing():
    _models: Dict[str, InputOutputPricing] = {
        ...
        "llama-3.1-70b-versatile": {"input_tokens_cost": 0.59, "output_tokens_cost": 0.79},
        "gemma2-9b-it": {"input_tokens_cost": 0.20, "output_tokens_cost": 0.20},
        "anthropic.claude-3-haiku-20240307-v1:0": {"input_tokens_cost": 0.25, "output_tokens_cost": 1.25},
    }
    ...
    @staticmethod
    def calculate_cost(model: str, input_tokens: int, output_tokens: int) -> InputOutputPricing:
        ...
        return {"input_tokens_cost": input_tokens_cost, "output_tokens_cost": output_tokens_cost}